...
public class FlowerSpawner : MonoBehaviour
{
    ...
    private void CreateFlowers() 
    {
        ...
        if (Input.GetMouseButtonDown(0) && _flowerCadence < _flowers.Length) {
            ...
            Vector3 flowerPosition = _flowerLauncher.transform.position;

            //Creamos la rotación de las flores en el punto de rotación del objeto de control
            Quaternion flowerRotation = _flowerLauncher.transform.rotation;
            ...
            GameObject cloneFlower = Instantiate(_flowers[_flowerCadence], flowerPosition, flowerRotation);

            //De cada flor obtenemos el "RigidBody"
            Rigidbody _rbFlowers = cloneFlower.GetComponent<Rigidbody>();
